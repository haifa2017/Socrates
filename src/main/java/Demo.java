...
class Demo {
    public static void main(String[] args) {
        ...
        checkIns.addCheckIn(new EventDate(LocalDateTime.of(2019, 4, 11, 23, 0, 0)));
        System.out.println("Laurent arrive à 18h");
        checkIns.addCheckIn(new EventDate(LocalDateTime.of(2019, 4, 11, 18, 0, 0)));
        ...
        checkIns.addCheckIn(new EventDate(LocalDateTime.of(2019, 4, 12, 3, 0, 0)));
